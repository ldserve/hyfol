        ...
        _createClass(Cart, [{
            ...
            value: function _updateQuantity(event, target) {
                ...
                try { var {commodity_tag} =JSON.parse(productData)
                    if(target.getAttribute('data-action')=="increase-quantity" && commodity_tag.indexOf('fsl')!=-1){
                            Message.error("You already have this item's max quantity (1) in your cart.")
                            return false
                        }else if(target.getAttribute('data-action')=="decrease-quantity" && commodity_tag.indexOf('fsl')!=-1)allProductTag='';} catch (error) {}
                document.dispatchEvent(new CustomEvent('theme:loading:start'));
        ...
        _createClass(ProductVariants, [{
            ...
            value: function _addToCart(event, target) {
                ...
                try {
                    ...
                    if(allProductTag && commodity_tag.indexOf('fsl')!=-1 && allProductTag.indexOf('fsl')!=-1){
                      Message.error("You already have this item's max quantity (1) in your cart.")
                        return false
                    }else if(commodity_tag.indexOf("fsl")!=-1)allProductTag=commodity_tag;
                } catch (error) {}
